    ...
    return (
      <div className="container robin-williams-container">
        <div className="container robin-williams-content">
          ...
          />
          <p>
            I watched Robin Williams Remembered: A love letter to a unique and irrepressible comic talent, who left us
            far too soon, & Robin Williams: Come Inside My Mind, which takes it's viewers through the one-of-a-kind
            actor and comedian's extraordinary life and career, revealing what drove him to give voice to the incredible
